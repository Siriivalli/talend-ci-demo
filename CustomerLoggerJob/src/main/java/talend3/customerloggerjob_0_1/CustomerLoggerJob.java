...
package talend3.customerloggerjob_0_1;
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String projectName = "TALEND3";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_UhKq4FvHEfCAaqllTmZ74A", "0.1");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_TALEND3_CustomerLoggerJob = new byte[0];
    static byte[] commonByteArray_TALEND3_CustomerLoggerJob = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TALEND3_CustomerLoggerJob.length) {
				if(length < 1024 && commonByteArray_TALEND3_CustomerLoggerJob.length == 0) {
   					commonByteArray_TALEND3_CustomerLoggerJob = new byte[1024];
				} else {
   					commonByteArray_TALEND3_CustomerLoggerJob = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TALEND3_CustomerLoggerJob, 0, length);
			strReturn = new String(commonByteArray_TALEND3_CustomerLoggerJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_TALEND3_CustomerLoggerJob, 0, length);
			strReturn = new String(commonByteArray_TALEND3_CustomerLoggerJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TALEND3_CustomerLoggerJob) {
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tFileInputDelimited_1", "xjxhnq_");
 ...
 */
                ...
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "\"D:/fs/talend/customers.csv\"");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "D:/fs/talend/customers.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("D:/fs/talend/customers.csv", "ISO-8859-15",",","\n",true,1,0,
 ...
 */
	...
	s(currentComponent="tFileInputDelimited_1");
                ...
                if(!((Object)("D:/fs/talend/customers.csv") instanceof java.io.InputStream)){
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'CustomerLoggerJob' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_UhKq4FvHEfCAaqllTmZ74A");
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-07-08T08:14:05.120907500Z");
        ...
        try {
            ...
            java.io.InputStream inContext = CustomerLoggerJob.class.getClassLoader().getResourceAsStream("talend3/customerloggerjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     80186 characters generated by Talend Cloud Data Management Platform 
 *     on the 8 July 2025 at 1:44:05 pm IST
 ************************************************************************************************/